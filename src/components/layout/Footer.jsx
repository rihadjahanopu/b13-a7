...
export function Footer() {
  return (
    <footer className="w-full bg-[#1e3c2f] text-white py-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        <h2 className="text-2xl font-bold mb-4">KeenKeeper</h2>
        <p className="text-gray-300 text-sm mb-6 text-center max-w-md">
          A minimalist dashboard to help you maintain and grow the relationships that matter most to you.
        </p>
