					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 flex flex-col items-center text-center">
						...
						<div className="flex gap-2 justify-center mb-6">
							{friend.tags?.map((tag) => (
								<span
									key={tag}
									className="px-3 py-1 rounded-full text-[10px] font-bold bg-[#cdedd9] text-[#2d5a45] uppercase tracking-wider">
									{tag}
								</span>
							))}
						</div>
				...
				<div className="grow flex flex-col gap-6">
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
						<div className="bg-white rounded-xl shadow-sm border border-gray-100 py-6 text-center">
							<h3 className="text-3xl font-bold text-[#2d5a45] mb-2">
						...
						<div className="bg-white rounded-xl shadow-sm border border-gray-100 py-6 text-center">
							<h3 className="text-[22px] md:text-[26px] font-bold text-[#2d5a45] mb-2 whitespace-nowrap">
								{friend.nextDue}
							</h3>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
						<div className="flex justify-between items-center mb-6">
							<h2 className="text-[17px] font-bold text-[#2d5a45]">
								Relationship Goal
							</h2>
